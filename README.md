...
The "your-custom-values.yaml" is configured to work with New Relic's Otel Distribution (nrdot). See [k8s/README.md](k8s/README.md) for details on the custom OTLP pipelines defined there.
